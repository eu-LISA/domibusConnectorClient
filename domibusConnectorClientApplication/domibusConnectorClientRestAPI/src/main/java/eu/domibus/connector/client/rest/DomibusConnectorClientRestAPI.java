...
/**
 * This interface is a public interface for the domibusConnectorClient-Application to be approached from outside.
 * It is used by the domibusConnectorClient-UI to connect to and exchange data with the application.
 * 
 * @author riederb
 *
 */
...
public interface DomibusConnectorClientRestAPI {
	 ...
	 * 
	 * @param id - the database id (technical key) of the message. Usually not used to display message data.
	 ...
	 * @throws MessageNotFoundException if the message with the given the backend message id is not present.
	 */
	...
	/**
	 * With this method a message can either be created (if not done yet), or updated. This is for the data contained within the message object.
	 * It does not save message attachments such as files.
	 * @param message - The message object with the new data contained.
	 * @return The message object after the update happened. If the message is new it is enriched by the database id.
	 ...
	 * @param messageFile - The object holding all necessary information and the bytes of the file to be stored.
	...
	/**
	 * Deletes a message. The message is deleted from the database of the domibusConnectorClient-Application. Also in the storage the message
	 * is deleted.
	 ...
	 * @throws StorageException if the stored storage location cannot be found or the stored message cannot be deleted.
	 */
	@PostMapping(
	...
	/**
	 * Method to submit an already stored and prepared message to the connector. To be successful the message needs to be prepared entirely.
	 * This method relies on the storage. So, the message to be submitted, is loaded entirely from the storage.
	 ...
	 * @throws StorageException if the stored storage location cannot be found or the stored message cannot be loaded from storage.
	 ...
	 * @throws StorageException if the stored storage location cannot be found or the stored file cannot be deleted.
	 */
	@PostMapping(
