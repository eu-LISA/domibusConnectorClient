...
/**
 * Configuration class for the Connector Client Auto Configuration.
 * This class is responsible for configuring the properties related to the Connector Client library.
 * The properties can be customized by using the {@code application.properties} file or
 * by using the corresponding setters provided in this class.
 *
