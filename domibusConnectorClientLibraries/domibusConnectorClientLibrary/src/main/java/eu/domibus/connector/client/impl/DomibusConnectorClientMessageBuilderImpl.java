 ...
 * DomibusConnectorClientMessageBuilder interface. This class is responsible for constructing
 * DomibusConnectorMessageType objects that represent messages in the Domibus connector system. It
 * provides methods for creating new messages, adding business content, adding business documents,
 * and adding attachments to a message.
 */
@Component
