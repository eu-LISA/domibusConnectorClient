...
/**
 * The {@code DomibusConnectorClientMessageHandlerImpl} class is an implementation of the
 * {@link DomibusConnectorClientMessageHandler} interface. It provides methods to prepare inbound
 * and outbound messages' business content XML before submitting or delivering them.
 */
@Component
