...
public interface DomibusConnectorClientMessageBuilder {
	...
	/**
	 * Creates a new {@link DomibusConnectorMessageType} and adds the {@link DomibusConnectorMessageDetailsType}.
	 ...
	 * 
	* @param ebmsMessageId - The EBMS message id of the message this confirmationMessage refers to. Will be set as refToMessageId.
	 * @param conversationId - The conversation of the message this confirmationMessage refers to.
	 * @param businessService - The {@link DomibusConnectorServiceType} of the message this confirmationMessage refers to.
	 * @param businessAction - The business action representing the confirmationType of this confirmationMessage. Must be defined by the use case (PModes).
	 * @param fromParty - The {@link DomibusConnectorPartyType} of the receiving Party (toParty) of the message this confirmationMessage refers to.
	 * @param toParty - The {@link DomibusConnectorPartyType} of the sending Party (fromParty) of the message this confirmationMessage refers to.
	 * @param finalRecipient - The electronic identifier of the original sender of the message this confirmationMessage refers to.
	 * @param originalSender - The electronic identifier of the final recipient of the message this confirmationMessage refers to.
